...
object ArmConstants {
  ...
  const val FIRST_ENCODER_OFFSET = 0.25 + (.25 - 0.150425) + (0.25 - 0.243137) + (0.25 - 0.248505) + (0.25 - 0.254607)
  const val SECOND_ENCODER_OFFSET = 0.081042 - 0.003050 - 0.004135 + 0.003173 // 0.855081
